...
Fidely UI is built on top of **Panda CSS**, so you can customize it at the token, theme, and component levels by
default **fidely** use both neutral for it **grayColor** and **accentColor**
