---
title: Contributing to Fidely UI
description: Learn how to contribute to Fidely UI, from fixing bugs to adding components and documentation.
---
...
If you make changes to **presets** or **React components**, be sure to run:
