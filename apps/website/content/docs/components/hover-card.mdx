...
Use the **`--hovercard-bg`** CSS variable to change the background color of the **HoverCard** content and its arrow.

<ExampleTabs name="hover-card-with-bg" scope="hover-card" />
