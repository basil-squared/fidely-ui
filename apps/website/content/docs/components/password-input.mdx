...
links:
  source: password-input/password-input.tsx
  recipe: slot-recipe/passwordInput.recipe
  ark: components/password-input
---
...
<ExampleTabs name="password-input-invalid" scope="password-input" />
